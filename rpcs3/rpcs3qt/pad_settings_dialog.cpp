...
void pad_settings_dialog::ChangeHandler()
{
	...
	case pad_handler::dolphinbar: m_description = tooltips.gamepad_settings.move; break; // Reuse move tooltip
#ifdef _WIN32
...
QString pad_settings_dialog::GetLocalizedPadHandler(const QString& original, pad_handler handler)
{
	switch (handler)
	{
		...
		case pad_handler::dolphinbar: return tr("DolphinBar Wiimote");
#ifdef _WIN32
...
QString pad_settings_dialog::GetLocalizedPadName(pad_handler handler, const QString& original, usz index)
{
	switch (handler)
	{
		...
		case pad_handler::dolphinbar: return tr("DolphinBar Wiimote #%0").arg(index);
#ifdef _WIN32
